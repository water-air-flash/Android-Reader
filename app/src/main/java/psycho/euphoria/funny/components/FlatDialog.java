...
import psycho.euphoria.funny.utils.ViewUtilities;
...
public class FlatDialog {
    ...
    public FlatDialog setView(View view) {
        mView = view;
        if (mBuilder != null) {
    ...
    public FlatDialog setBackground(Drawable drawable) {
    ...
    public FlatDialog setBackgroundResource(int resId) {
    ...
    //Build.VERSION_CODES.L=21
    private static boolean isLollipop() {
        return Build.VERSION.SDK_INT >= 21;
    }

    public FlatDialog setTitle(int resId) {
        mTitleResId = resId;
        if (mBuilder != null) {
    ...
    public FlatDialog setTitle(CharSequence title) {
        mTitle = title;
        if (mBuilder != null) {
    ...
    public FlatDialog setMessage(int resId) {
        mMessageResId = resId;
        if (mBuilder != null) {
    ...
    public FlatDialog setMessage(CharSequence message) {
        mMessage = message;
        if (mBuilder != null) {
    ...
    public FlatDialog setPositiveButton(int resId, final View.OnClickListener listener) {
    ...
    public FlatDialog setPositiveButton(String text, final View.OnClickListener listener) {
        mPositiveButton = new Button(mContext);
        LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(
                LinearLayout.LayoutParams.WRAP_CONTENT,
                LinearLayout.LayoutParams.WRAP_CONTENT
    ...
    public FlatDialog setNegativeButton(int resId, final View.OnClickListener listener) {
    ...
    public FlatDialog showDialogProgressBar() {
        final View progressBar = ViewUtilities.findView(mView, R.id.ui_float_dlg_progress);
        ViewUtilities.show(progressBar);
        return this;
    }

    public FlatDialog setNegativeButton(String text, final View.OnClickListener listener) {
        mNegativeButton = new Button(mContext);
        mLayoutParams = new LinearLayout.LayoutParams(
                LinearLayout.LayoutParams.WRAP_CONTENT,
                LinearLayout.LayoutParams.WRAP_CONTENT
    ...
    public FlatDialog setCanceledOnTouchOutside(boolean cancel) {
        this.mCancel = cancel;
        if (mBuilder != null) {
    ...
    public FlatDialog setOnDismissListener(DialogInterface.OnDismissListener onDismissListener) {
    ...
    private class Builder {
        ...
        private Builder() {
            ...
            View contv = LayoutInflater.from(mContext).inflate(R.layout.layout_flat_dialog, null);
            ...
            // mAlertDialogWindow.setContentView(R.layout.layout_FlatDialog);
